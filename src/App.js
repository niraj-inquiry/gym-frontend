...
function App() {
 ...
 useEffect(()=>{
//    if (!JSON.parse(localStorage.getItem('vendorAuth'))) {
    ...
    return (
        <div className="App">
            ...
            <Routes>
                ...
                <Route
                    path="/terms_and_condtions"
                    element={<Terms_And_Condtions />}
                />
                ...
                <Route
                    path="/gym_listing_details"
                    element={<Gym_Listing_Details />}
                />
                ...
                <Route path="/superactive-owner-form" element={<SuperactiveOwnerForm />} />
                <Route path="/superactive-owner-listing" element={<SuperActiveListing />} />
                <Route path="/superactive-owner" element={<SuperActiveOwner />} />

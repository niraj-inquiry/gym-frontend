...
import { UserSettingInput, InputBoxReadOnlycmp, InputBoxTextArea } from '../Element/vendercom/InputBox';
...
import { UserSettingAddButton, CustomButton } from '../Element/vendercom/AddButton';
            ...
            <section className='section_heading w-80 mx-auto commpad p-5' style={{ backgroundColor: '#d3d3d370' }}>
                <div style={{ width: '100%', margin: 'auto' }} className='text-start pb-5 '>
                    ...
                    <div className='text-end'>
                        <i className="fa fa-edit editclass" onClick={() => setEditstatus(!editstatus)}></i>
                    </div>
                    <div className='row'>
                        <div className='col-lg-6 py-2'>
                            <div className='container-fluid border w-auto py-1 rounded' style={{ backgroundColor: '#fff' }}>
                                ...
                                <div className='row py-2'>
                                    ...
                                    {/* <UserSettingInput
                                        ...
                                        setState={setFirstname && setLastname}
                                      
                                        state={`${firstname} ${lastname}`}
                                       
                                        inputcss={editstatus ? "border-0 text-center w-100 px-3 py-1" : " px-3 py-1 w-100 border"}
                                    ...
                                    <div className={"d-flex flex-row py-2 justify-content-between"}>
                                        <label htmlFor="validationDefault02" className="form-label mb-0 col-6" style={{}}>
                                        {"Name"}
                                        </label>
                                        <div className={`d-flex align-items-center col-6 `}>
                                            <input type={"text"}
                                                ...
                                                className={editstatus ? "border-0 text-center w-100 px-3 py-1" : " px-3 py-1 w-100 border"}
                                    ...
                                    <UserSettingDropdownCustom
                                        ...
                                        defaultvalue={isNaN(userdata?.gender)?"":userdata?.gender}
                                        inputcss={editstatus ? "ms-1 px-3 py-1 w-100 text-center border-0" : "px-3 py-1 w-100 text-center"}
                                        json={genderdropdown}
                                        setState={setGender}
                                    />
                        ...
                        <div className='col-lg-6  py-2'>
                            <div className='container-fluid border w-auto py-1 rounded' style={{ backgroundColor: '#fff' }}>
                                <h3 className='py-3 border-bottom mb-0'>{"Communication Channels"}</h3>
                                <div className='row py-2'>
                                    <CommunicationForm communicationjson={communicationjson} onClick={(data, index) => onChangeCommunication(data, index)} />
                        ...
                        <div className='col-lg-6  py-2'>
                            <div className='container-fluid border w-auto py-1 rounded' style={{ backgroundColor: '#fff' }}>
                                <h3 className='py-3 border-bottom'>{"SuperActive communication preferences"}</h3>
                                <div className='row py-2 '>
                                    <CommunicationForm communicationjson={preferrencejson} onClick={(data, index) => onChangePreferrence(data, index)} />

                                </div>
                            </div>
                        </div>
                        <div className='col-lg-6 py-2'>
                            <div className='container-fluid border w-auto py-1 rounded' style={{ backgroundColor: '#fff', marginTop: '-4%' }}>
                                <h3 className='py-3 border-bottom'>{"Manage your personal data"}</h3>
                                <div className='w-100 ' style={{ fontSize: 12 }}>{"Enter your password to view and download the personal data you have provided to us."}</div>
                                <div className='row py-2 '>
                                    ...
                                    <div className='col-lg-4 col-md-4 col-sm-4'>
                                        <CustomButton label={"Download"} className={'explore-btn py-1 w-auto'} />
                                    </div>
                                </div>
                    ...
                    <UserSettingAddButton label={"Save Changes"} onClick={() => onSaveChanges()} />
                </div>
            </section>

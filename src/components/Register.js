        ...
        <>
            ...
            <section className="section_heading py-5">
                <div className="refer-friend-box" style={{width:'70%'}}>
                    <div className="container p-0 w-100" style={{marginRight:'auto',marginLeft:'auto',maxWidth: '1335px'}}>
                                    ...
                                    <div className="p-0">
                                        ...
                                        <div className="info-form text-start mt-4">
                                            <div className="row">
                                                ...
                                                <div onClick={()=>setHideshow(!hideshow)} className="col-lg-12 position-relative mt-3">
                                                    <div>
                                                        <input
                                                      ...
                                                      <i className={hideshow?"fa fa-eye":"fa fa-eye-slash  hide-pass"} />
                                                ...
                                                <div className="col-lg-6 position-relative mt-3">
                                                    ...
                                                    {postcodevalid && !postcoderegrex &&(
                                                        <>
                                                            <span>❌ Please enter the post code/pin code</span>
                                                        </>
                                                    )}
                                                    {postcoderegrex && !postcodevalid && (
                                                        <>
                                                            <span>❌ Please enter the valid post code/pin code</span><br></br>
                                                ...
                                                <div className="col-lg-6 position-relative mt-3">
                                                    ...
                                                    {descriptionvalid && (
                                                        <>
                                                        <span className="w-50">❌ Select the dropdown list</span>
                                                        </>
                                                    )}
                                                </div>

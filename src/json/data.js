...
export const resources = [{
  ...
  function getRandomText(textIndex) {
    ...
    return (appointmentsText.map(i => i.text)[textIndex % appointmentsText.length]);
    // return(
    //   resources.map((e,i)=>{
    //     const temp = appointmentsText.filter(element => 
    //         element.assignUserId === e.id 
            
    //       );
    //       if(temp===temp.assignUserId){
    //         temp.map(i => i.text);
    //       }

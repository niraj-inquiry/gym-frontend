  ...
  return (
    <div className="">
      ...
      <div className="w-100row my-4">
        ...
        {/* <div className="col-lg-3 col-md-6 col-sm-12 mb-3 w-100 border-bottom border-0 "> */}
          <DatePicker
            type="datetime-local"
          ...
          />
        {/* </div> */}
        {/* <div className="col-lg-3 col-md-6 col-sm-12 mb-3 border-bottom border-0 w-100"> */}

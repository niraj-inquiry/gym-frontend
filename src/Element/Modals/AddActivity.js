...
import { InputBox, InputBoxReadOnlycmp, InputBoxTextArea, InputBoxcmp } from '../../Element/vendercom/InputBox'
...
const AddActivity = ({ data, setdata, modalstate, onClose, vendoroption }) => {
  ...
  const handleInputChange = (e) => {
    ...
    const filteredSuggestions = findgymdata.filter(item =>
      ...
      <div className="modal-dialog modal-xl">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title text-center w-100 fw-bold fs-4" id="exampleModalLabel">Activity Data</h5>
            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={onClose}></button>
          </div>
          <Tabs json={tabsinfo} onClick={(data) => { setSelecttab(data) }} />
          {selecttab === 0 && (
            <div className="modal-body pt-0">
              <div class=" profile-box pt-0 border-0">
                {/* <h3>Center Details</h3> */}
                {/* gymdetails */}
                <div className='row justify-content-end'>
                  <div className="col-lg-3 search-gym fs-6 text-start mx-3">
                    <input
                    ...
                    <img
                      ...
                      alt="gym-studio"
                      src={Images.search}
                      style={{ right: '10%', width: 20, height: 20 }}
                    />
                  ...
                  <div className='w-100'>
                    ...
                    <>
                    <div className='text-start ms-auto py-4 border border-3 rounded px-3 vendorfilter' style={{width:'300px'}}>
                ...
                <div className="row g-4 m-0">
                  <div className='text-start fw-bold mt-0'>{"Organizer Details"}</div>
                  <div className='col'>
                    <InputBoxcmp
                      defaultValue={data?.center_name}
                      label={"Name"}
                ...
                <button
                  type="button"
                  style={{ backgroundColor: "black", borderRadius: 5 }}
                  className="explore-btn px-5 py-2 float-end me-2 mt-4"
                  onClick={() => onSavegymdetails()}
                >
                  <span className="position-relative fs-5 w-20 ">Save</span>
                </button>
          ...
          {selecttab === 1 && (
            <div class="profile-box px-3 border-0 pt-0">
              <div class="row justify-content-end p-5 pt-0">

                <div className="col-lg-12 col-md-12 g-4 pt-0 m-0 flex px-0">
